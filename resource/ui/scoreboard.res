"Resource/UI/Scoreboard.res"
{
	...
	"Knuckles Crosshairs"
	{
		"visible" 									"1"		//to remove the crosshair when pressing tab set this to 0
		...
		"fgcolor" 									"0 255 0 255"
		"labelText"									"f"						//You can change this to use a different crosshair, see the list of crosshairs in Knuckles - Crosshairs.png
